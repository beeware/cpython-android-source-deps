...
export CFLAGS=""
export LDFLAGS="-Wl,--exclude-libs,libgcc.a -Wl,--exclude-libs,libgcc_real.a \
-Wl,--exclude-libs,libunwind.a -Wl,--build-id=sha1 -Wl,--no-rosegment"
...
case $abi in
    armeabi-v7a)
        ...
        ;;
    x86)
        # -mstackrealign is unnecessary because it's included in the clang launcher
        # script which is pointed to by $CC.
        ;;
esac
